...
```json
{
  "mcpServers": {
    "github": {
      "command": "declaw",
      "args": ["mcp", "--network-allow", "api.github.com,github.com", "--", "npx", "-y", "@modelcontextprotocol/server-github"],
      "env": { "GITHUB_PERSONAL_ACCESS_TOKEN": "ghp_..." }
    }
  }
}
...
```bash
claude mcp add github -- declaw mcp --network-allow api.github.com,github.com -- npx -y @modelcontextprotocol/server-github
```
